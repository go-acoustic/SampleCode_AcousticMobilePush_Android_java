...
public class SampleNotifier extends MceBroadcastReceiver {
    ...
    protected static final String TAG = SampleNotifier.class.getName();

    public static final String ACTION_KEY = "action";
    public static final String ACTION_SDK_REGISTRATION = "sdkreg";
    public static final String ACTION_MSG_SVC_REGISTRATION = "msgsvcreg";
